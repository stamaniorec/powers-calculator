...
/*! Color is maximum 16bit data */
typedef U16 Color_t;
typedef U8 Coordinate_t;
...
#define LCD_COLOR_WHITE		((Color_t) 0xFFF)
#define LCD_COLOR_RED		((Color_t) 0x00F)
#define LCD_COLOR_GREEN		((Color_t) 0x0F0)
#define LCD_COLOR_BLUE		((Color_t) 0xF00)
#define LCD_COLOR_BLACK		((Color_t) 0x000)
#define LCD_COLOR_CYAN		((Color_t) 0xFF0)
#define LCD_COLOR_YELLOW	((Color_t) 0x0FF)
#define LCD_COLOR_MAGENTA	((Color_t) 0xF0F)
#define LCD_COLOR_SALMON	((Color_t) 0x79E)
#define LCD_COLOR_BROWN		((Color_t) 0x22A)
#define LCD_COLOR_ORANGE	((Color_t) 0x07F)
#define LCD_COLOR_VIOLET	((Color_t) 0xC09)
#define LCD_COLOR_GRAY		((Color_t) 0x777)
#define LCD_COLOR_PINK		((Color_t) 0x19F)
#define LCD_COLOR_DRED		((Color_t) 0x00A)
#define LCD_COLOR_DGREEN	((Color_t) 0x0A0)
#define LCD_COLOR_DBLUE		((Color_t) 0xA00)
...
void LCDSetLine(int x1, int y1, int x2, int y2, Color_t color);
